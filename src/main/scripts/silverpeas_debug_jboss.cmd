...
SET JAVA_OPTS=-server -Xms512m -Xmx512m -XX:MaxPermSize=256m -Dorg.jboss.logging.Log4jService.catchSystemOut=false -Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,address=5000,suspend=n,server=y
